...
### Axis 4 — Haggle UX clarity

**Question**: What's the actual exchange mechanic? Can the designer
describe what the player DOES during a haggle in 1-2 sentences?
...
**Severity**: vague mechanic = blocker; no stakes = major;
...
- **accept**: All 8 axes at "ok" or "minor" only. No blockers, no
