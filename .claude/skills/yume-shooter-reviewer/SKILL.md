...
GDDs. You run AFTER `yume-game-reviewer`'s generic 13-axis review
accepts. The generic reviewer is the floor; you are the ceiling.

## Why this skill exists

The generic 13-axis reviewer catches what's wrong with any game.
...
- A GDD at `docs/games/<game-name>/GDD.md` that has already been
  accepted by `yume-game-reviewer` (generic 13-axis). If it hasn't,
...
- The GDD does NOT proceed to systems-designer / content-designer
  even if the generic 13-axis accepted.
...
- ❌ Re-do the generic 13-axis (yume-game-reviewer's job)
...
- `.claude/skills/yume-game-reviewer/SKILL.md` — the generic 13-axis
  this layer extends
