...
_Generated: 2026-05-06T15:39:47+00:00_
...
30 effect types (used as `rule.effect[].type`):
...
- `show_overlay` — `effect_apply.gd`
- `dismiss_overlay` — `effect_apply.gd`
- `set_audio_bus_volume` — `effect_apply.gd`
