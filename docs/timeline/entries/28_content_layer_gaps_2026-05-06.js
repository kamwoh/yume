export const entry28 = {
  ...
  highlights: [
    ...
    "<strong>Gap 1 — No 'drafting on X' discipline</strong>: every shipped game stands on shoulders (Stardew = Harvest Moon + AC + Terraria; Recettear = 'play the shopkeeper'). Yume games design in a vacuum. game-designer writes 'merchant game' without 'we're drafting Recettear, keep these 3, change these 2'. Fix: reference-design discipline added to game-designer + GDD section requiring 2-3 named games drafted on, with concrete what-we-keep/change.",
    ...
    "<strong>Gap 3 — No charm / voice / character-density discipline</strong>: Stardew has 30+ NPCs with names + voices + schedules + heart events + arcs. game-planner produces 'named cast' but they're skeletons. Nobody puts FLESH on them. Fix: character-voice-designer skill OR more demanding game-planner.",
